package com.example.pe_se150058.provider;
...
public class CarProvider extends ContentProvider {
    ...
    private static final String AUTHORITY ="com.example.pe_se150058.provider.CarProvider";
    public static final Uri CONTENT_URI = Uri.parse("content://" + AUTHORITY + "/"+DataAdapter.TABLE_NAME);
    ...
    static{
        uriMatcher.addURI(AUTHORITY, DataAdapter.TABLE_NAME, CarS);
        uriMatcher.addURI(AUTHORITY,DataAdapter.TABLE_NAME + "/#", Car_ID);
    }
    ...
    public Uri insert(@NonNull Uri uri, @Nullable ContentValues contentValues) {
        ...
        return Uri.parse(DataAdapter.TABLE_NAME + "/" + id);
    }
